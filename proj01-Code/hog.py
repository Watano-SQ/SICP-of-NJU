...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for _ in range(1,num_rolls+1):
        ...
        if addnum == 1:
            ...
            point = point + addnum
    for _ in range(1,1 + num_rolls - time):
        dice()
    return point 
    # END PROBLEM 1
...
def play(strategy0, strategy1,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            point = take_turn(strategy0(score0,score1),score1,dice)
            score0 = score0 + point
            if swine_swap(score0): 
                score0, score1 = score1, score0
        if who == 1:
            point = take_turn(strategy1(score1,score0),score0,dice)
            score1 = score1 + point
...
def is_always_roll(strategy, goal=GOAL_SCORE):
    ...
    big = 10 
    small = 5
    num1 = strategy(big,small)
    num2 = strategy(small,big)
    if num1 == num2:
        return True
    else:
        return False
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def later_function(*arg):
        average_point = 0 
        for _ in range(1,trials_count+1):
            average_point = average_point + original_function(*arg)
        average_point = average_point / trials_count
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    "*** YOUR CODE HERE ***"
    undetermined = 1
    undetermined_point = 0
    for time in range(1,11):
        point = 0
        for _ in range(1,total_samples+1):
            point = point + roll_dice(time,dice)
        average_point = point / total_samples
        if average_point > undetermined_point:
            undetermined = time
            undetermined_point = average_point
    return undetermined
    # END PROBLEM 9
...
def picky_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 10
    "*** YOUR CODE HERE ***"
    piggy_point = picky_piggy(opponent_score)
    if piggy_point >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def swine_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    "*** YOUR CODE HERE ***"
    later_score = score + picky_piggy(opponent_score)
    if swine_swap(later_score):
